...
def search_tickets(hs_key, st_date, df2):
    st_date = st_date
    ...
    while st_date < current_date:
        ...
        print(f"Searching tickets for month: {st_date} to {en_date}")
        ...
        properties = [
            'hs_object_id', 'subject', 'createdate', 'closedate', 'hs_lastmodifieddate', 'hs_pipeline', 'hs_pipeline_stage', 'hubspot_owner_id',
            'gx_specialist_poc'
        ]
        ...
        try:
            while True:
                api_response = api_client.crm.tickets.search_api.do_search(public_object_search_request=public_object_search_request)
...
#     # Call search_deals with your HubSpot API key and df2
#     # df2 will be updated with results for each month from 2023-10-01 until current month
#     df2 = search_tickets(creds.hs_prod_key, date, df2)
#     return df2
...
# print(tickets_df)
# date = "2024-08-01"
# tick = search_tickets(creds.hs_prod_key, date)
# print(type(tick))
